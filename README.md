...
- Note: This project was initially created in 2023, in collaboration with [Shashank](https://github.com/Shanki200801), [Mohit](https://github.com/programmingMohit) and [Siddharth](https://github.com/SiddharthSai4701) as part of our course completion project for uni, and was then put away. In 2025, I picked it up again in an effort to hone my skills (especially backend), but to also craft it like the designs I had in mind, hence not only revamping the UI entirely, but also improving the functionality overall, addressing security gaps & also adding some new features. :)  
